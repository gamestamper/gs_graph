...
describe GSGraph::Page do
  ...
  subject do
    GSGraph::Page.new(attributes[:id], attributes)
  end
  ...
  describe '.fetch' do
    ...
    its(:cover)      { should be_instance_of GSGraph::Cover }
    ...
    context 'when access_token field fetched' do
      subject do
        mock_graph :get, 'my_page', 'pages/with_token', :access_token => 'user_token', :params => {
          ...
          GSGraph::Page.fetch('my_page', :fields => :access_token, :access_token => 'user_token')
        end
      end
  ...
  describe '#get_access_token' do
    it 'should specify fields=access_token' do
      expect do
        GSGraph::Page.new('GSGraph').page_access_token
      end.to request_to 'GSGraph?fields=access_token', :GET
    end
    ...
    it 'should return Rack::OAuth2::AccessToken::Legacy' do
      mock_graph :get, 'page_id', 'pages/with_token', :access_token => 'user_token', :params => {
        ...
        page = GSGraph::Page.new('page_id', :access_token => 'user_token')
