...
describe GSGraph::Connections::AdGroups, '#ad_creatives' do
  context 'when included by GSGraph::AdGroup' do
    context 'when access_token is given' do
      it 'should return ad_creatives as GSGraph::AdCreative' do
        mock_graph :get, '22334455/adcreatives', 'ad_groups/ad_creatives/22334455_ad_creatives', :access_token => 'access_token' do
          ad_creatives = GSGraph::AdGroup.new('22334455', :access_token => 'access_token').ad_creatives
