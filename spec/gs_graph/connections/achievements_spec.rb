...
describe GSGraph::Connections::Achievements do
  let(:app) { GSGraph::Application.new('app_id', :access_token => 'app_token') }

  describe '#achievements' do
    it 'should return an Array of GSGraph::Achievement' do
      mock_graph :get, 'app_id/achievements', 'applications/achievements/sample', :access_token => 'app_token' do
        app.achievements.each do |achievement|
          achievement.should be_instance_of GSGraph::Achievement
