...
describe GSGraph::Connections::AdGroupStats, '#ad_group_stats' do
  context 'when included by GSGraph::AdAccount' do
    context 'when access_token is given' do
      it 'should return ad_group_stats as GSGraph::AdGroupStat' do
        mock_graph :get, 'act_11223344/adgroupstats', 'ad_accounts/ad_group_stats/test_ad_group_stats', :access_token => 'access_token' do
          ad_group_stats = GSGraph::AdAccount.new('act_11223344', :access_token => 'access_token').ad_group_stats

          ad_group_stats.size.should == 3
          ad_group_stats.total_count.should == 3081
          ad_group_stats.each { |ad_group_stat| ad_group_stat.should be_instance_of(GSGraph::AdGroupStat) }
          ad_group_stats.first.should == GSGraph::AdGroupStat.new(
