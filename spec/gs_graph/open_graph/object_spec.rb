...
describe GSGraph::OpenGraph::Object do
  subject do
    GSGraph::OpenGraph::Object.new attributes[:id], attributes
  end
  let :attributes do
  ...
  context 'with custom action' do
      ...
      <<-JSON
        {
          ...
          "description": "Custom Object for GSGraph testing",
    ...
    its(:description) { should == 'Custom Object for GSGraph testing' }
